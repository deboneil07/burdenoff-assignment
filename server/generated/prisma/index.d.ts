...
export namespace Prisma {
  ...
  */
  ...
  export interface Prisma__HabitClient<T, Null = never, ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> extends Prisma.PrismaPromise<T> {
    ...
    checkIns<T extends Habit$checkInsArgs<ExtArgs> = {}>(args?: Subset<T, Habit$checkInsArgs<ExtArgs>>): Prisma.PrismaPromise<$Result.GetResult<Prisma.$CheckInPayload<ExtArgs>, T, "findMany"> | Null>
    /**
     * Attaches callbacks for the resolution and/or rejection of the Promise.
     * @param onfulfilled The callback to execute when the Promise is resolved.
     * @param onrejected The callback to execute when the Promise is rejected.
  ...
  interface CheckInFieldRefs {
    ...
    readonly localDay: FieldRef<"CheckIn", 'String'>
    readonly occurredAt: FieldRef<"CheckIn", 'DateTime'>
  ...
  export type CheckInWhereInput = {
    ...
    localDay?: StringFilter<"CheckIn"> | string
    occurredAt?: DateTimeFilter<"CheckIn"> | Date | string
  ...
  export type CheckInWhereUniqueInput = Prisma.AtLeast<{
    id?: string
    habitId_localDay?: CheckInHabitIdLocalDayCompoundUniqueInput
    AND?: CheckInWhereInput | CheckInWhereInput[]
    OR?: CheckInWhereInput[]
    NOT?: CheckInWhereInput | CheckInWhereInput[]
    habitId?: StringFilter<"CheckIn"> | string
  ...
  export type CheckInScalarWhereWithAggregatesInput = {
    ...
    localDay?: StringWithAggregatesFilter<"CheckIn"> | string
    occurredAt?: DateTimeWithAggregatesFilter<"CheckIn"> | Date | string
  ...
  export type CheckInUpdateInput = {
    id?: StringFieldUpdateOperationsInput | string
    localDay?: StringFieldUpdateOperationsInput | string
